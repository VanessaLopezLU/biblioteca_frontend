<template>
  <v-card width="500px" class="mx-auto">
    <v-card-title>Teclado</v-card-title>
    <v-img
      height="297px"
      lazy-src="../../assets/images/teclado.jpeg"
      src="../../assets/images/teclado.jpeg"
    ></v-img>
    <v-card-text>
...
export default {
  ...
  async created() {
    //Buscar el id del tipo de equipo Teclado
    await axios
      .get(`${this.rutaBackend}/tipo-equipo/tipo/Teclado`)
      .then((response) => {
