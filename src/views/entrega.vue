  ...
  methods: {
    ...
    async buscarPrestamos() {
      if (this.$refs.form.validate()) {
        ...
        await axios
          .get(
            `${this.rutaBackend}/prestamo/usuario/${this.paquete.cedula}/entregar`,
            this.token
          )
          .then((response) => {
    ...
    async getInstructores() {
      await axios
        .get(`${this.rutaBackend}/usuario/instructor`, this.token)
        .then((response) => {
    ...
    async entregar() {
      if (this.indexSelecionado != null) {
        ...
        await axios
          .put(
            `${this.rutaBackend}/prestamo/entregar/${idPrestamo}`,{},
            this.token
          )
          .then((response) => {
            if (response.data) {
            ...
            this.paqueteMsj.body = response.data
              ? "Equipos entregados correctamente"
              : "No se pudieron entregar los equipos";
